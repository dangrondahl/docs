...
description: "How security and compliance teams use Kosli to enforce controls and prepare for audits."
---
...
<AccordionGroup>
  ...
  <Accordion title="How do I know a change is compliant?" icon="comment-question">
  ...
  <Accordion title="Can we map Kosli data to our compliance framework?" icon="comment-question">
  ...
  <Accordion title="How secure is the evidence?" icon="comment-question">
  ...
  <Accordion title="How do I use Kosli in an audit?" icon="comment-question">
