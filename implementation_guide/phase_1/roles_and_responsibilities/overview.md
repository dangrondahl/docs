...
## <Icon icon="arrows-spin"/> Phases of Implementation
...
## <Icon icon="people-group"/> Stakeholders
1. **[Platform Engineers and DevOps](/implementation_guide/phase_1/roles_and_responsibilities/platform_engineers)**: Leads technical implementation and pipeline integration
2. **[Application Developer](/implementation_guide/phase_1/roles_and_responsibilities/app_developers)**: Builds code and produces evidence automatically
3. **[Security and Compliance](/implementation_guide/phase_1/roles_and_responsibilities/security_compliance)**: Defines control objectives and verifies evidence
4. **Sponsors**: Champions adoption, aligns on outcomes, and tracks impact

## <Icon icon="chart-candlestick"/> RACI Matrix
...
<AccordionGroup>
    <Accordion title="A: Accountable" icon="star">
    ...
    <Accordion title="I: Informed" icon="eye">
