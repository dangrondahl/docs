...
description: "Role guide for Application Developers using Kosli"
---
...
<AccordionGroup>
  <Accordion title="Why did Kosli mark my build or deployment non-compliant?" icon="comment-question">
  ...
  <Accordion title="Do I need to learn another CLI or tool?" icon="comment-question">
  ...
  <Accordion title="How do I know if my change was successfully deployed?" icon="comment-question">
  ...
  <Accordion title="Can I use Kosli in debugging or incident response?" icon="comment-question">
...
- [**Querying Kosli**](): Learn how to search for artifacts or changes
- [**Concepts**](): Understand what Kosli tracks and why
