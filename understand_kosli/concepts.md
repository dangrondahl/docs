...
<img
  src="../images/kosli-concepts.jpg"
  alt="Kosli Concepts"
  style={{width: "900px"}}
  className="rounded-lg"
/>

## <Icon icon="sitemap"/> Organization
...
### <Icon icon="file-brackets-curly"/> Attestation
...
### <Icon icon="vault"/> Evidence Vault
...
## <Icon icon="box-open"/> Audit package
...
## <Icon icon="layer-group"/> Environment
...
### <Icon icon="camera"/> Environment Snapshot
...
### <Icon icon="scroll"/> Environment Policy
