---
title: "Environments"
description: "Learn how to create and manage Kosli environments to track your runtime artifacts."
icon: "layer-group"
---
...
* <Badge color="green">Compliant</Badge> - All artifacts in the snapshot satisfy the requirements defined in attached policies
* <Badge color="red">Non-compliant</Badge> - One or more artifacts violate the requirements defined in attached policies
* <Badge color="gray">Unknown</Badge> - No policies are attached to the environment, compliance requirements are undefined

When you create a new environment, it starts with an <Badge color="gray">Unknown</Badge> compliance state since no policies are attached
